  ...
  <tr><td style="background:#fff;border-radius:0 0 12px 12px;border:1px solid #dee2e6;border-top:none;">
    <table width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr><td style="padding:12px;text-align:center;background:#f8f9fa;border-radius:0 0 12px 12px;">
        <div style="font-size:11px;color:#adb5bd;">AI 自动生成 · 来源：X / 即刻 / Blog / Podcast</div>
      </td></tr>
    </table>
  </td></tr>
</table>
...
export async function deliver(markdown, articles, dateStr, tokenUsage = {}) {
  ...
  // GitHub Actions: smtp.gmail.com resolves fine.
  // Locally some IPs may be blocked; SMTP_HOST env can override the resolved IP
  // while tls.servername keeps certificate validation against smtp.gmail.com.
